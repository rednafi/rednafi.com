...
While I don't get to write much Go at work these days, I love using it to build my tools
and have been doing so for the past few years. Go doesn't need much evangelizing anymore,
but there's one talk I often point people to because it perfectly captures why writing a
server in Go makes so much sense.

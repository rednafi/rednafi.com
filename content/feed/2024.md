...
I like writing HTTP servers with Go's `net/http` library, and Matt shows how he organizes
his server codebase for better readability and testability. I've picked up quite a few neat
patterns from this. His take on testing is spot on—rather than testing each handler
